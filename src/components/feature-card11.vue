<template>
  <div class="feature-card11-feature-card" v-bind:class="rootClassName">
    <h2 class="feature-card11-text">{{ title }}</h2>
    <img :alt="image_alt" :src="image_src" class="feature-card11-image" />
  </div>
</template>
