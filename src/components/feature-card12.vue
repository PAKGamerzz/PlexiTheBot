<template>
  <div class="feature-card12-feature-card" v-bind:class="rootClassName">
    <h2 class="feature-card12-text">{{ title }}</h2>
    <img :alt="image_alt" :src="image_src" class="feature-card12-image" />
  </div>
</template>
