<template>
  <div class="feature-card13-feature-card" v-bind:class="rootClassName">
    <h2 class="feature-card13-text">{{ title }}</h2>
    <img :alt="image_alt" :src="image_src" class="feature-card13-image" />
  </div>
</template>
